        ...
        <div data-aos="fade-right" className="flexAbout">
          <div className="aboutText">
            ...
            {/* <p className="text2">
              ...
              <br></br>
              <p>I created <a className="linktwo bold" href="https://www.part-time-design.com/" target="_blank">Part Time Design</a>, a studio where I design and develop custom Shopify and Squarespace websites.</p>   <a className="linktwo bold" href="https://www.part-time-design.com/" target="_blank">View More</a>
